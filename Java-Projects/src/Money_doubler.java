...
public class Money_doubler {
	...
	public static void main(String[] args) {
		...
		*/
		...
		double a = 0.00; double p = 0.00; double i = 0; double n = 12;
		//https://www.javatpoint.com/Scanner-class (for scanner stuff)
		...
		while (true) {
			System.out.println("Enter your interest rate per compounding period (enter a value greater than 0 to but less than or equal to 100): ");
